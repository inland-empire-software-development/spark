...
export class MakeMetaNullable1589835256407 implements MigrationInterface {
    name = 'MakeMetaNullable1589835256407'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `firstName` `firstName` varchar(255) NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `lastName` `lastName` varchar(255) NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `avatarUrl` `avatarUrl` varchar(255) NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `status` `status` varchar(255) NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `website` `website` varchar(255) NULL", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `course_users_demo` ADD CONSTRAINT `FK_ee69a306960e3d3029f4a8f2810` FOREIGN KEY (`userDemoId`) REFERENCES `user_demo`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `website` `website` varchar(255) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `status` `status` varchar(255) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `avatarUrl` `avatarUrl` varchar(255) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `lastName` `lastName` varchar(255) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `user_meta_demo` CHANGE `firstName` `firstName` varchar(255) NOT NULL", undefined);
