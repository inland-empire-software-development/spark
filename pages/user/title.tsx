...
function Title(): JSX.Element {
  return (
      ...
      <p className="user-centered profile-title uk-padding-remove-bottom">Andy Mendez</p>
      {/* <div className="uk-overlay-primary uk-position-cover"></div> */}
      <p className=" user-centered role uk-margin-small uk-margin-remove-top">Cold Fusion Developer</p>
